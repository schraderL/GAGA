...
facetData$Genome.size<-as.numeric(gsub(",","",facetData$Genome.size.1))
facetData$Scaffold.N50<-as.numeric(gsub(",","",facetData$Scaffold.N50.1))
facetData$Contig.N50<-as.numeric(gsub(",","",facetData$Contig.N50))
facetData$Number.of.scaffolds<-as.numeric(gsub(",","",facetData$Number.of.scaffolds))
...
HiC=facetData$PacBio.Hi.C.scaffolded,
