...
ddHeatmapRNA$F<-0
ddHeatmapRNA$F[ddHeatmapRNA$Queen==1 |ddHeatmapRNA$Gyne==1 ]<-1
...
GAGA.quality.boxplots<-ggplot(dd,aes(y=N50mb,x=tech,fill=tech))+
  ...
  scale_y_log10()+
  theme_classic()+
  theme(legend.position = c(.8, .2),axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1),legend.title = element_blank())+
  xlab("")+
  ylab("scaffold N50 (Mb)")+
  scale_fill_gdocs()
```
