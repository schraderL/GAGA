...
cp /home/projects/ku_00039/people/igngod/Gene-annotation-pipeline-main/Data/Genomes/$OUTDIR/gene_families_pipeline/NPC2/Step2_bitacora/NPC2/NPC2_genomic_and_annotated_proteins_trimmed_idseqsclustered.gff3 Bitacora_raw.gff3
# Using untrimmed proteins
#cat /home/projects/ku_00039/people/igngod/Gene-annotation-pipeline-main/Data/Genomes/$OUTDIR/gene_families_pipeline/NPC2/Step2_bitacora/NPC2/Intermediate_files/NPC2_annot_genes.gff3 /home/projects/ku_00039/people/igngod/Gene-annotation-pipeline-main/Data/Genomes/$OUTDIR/gene_families_pipeline/NPC2/Step2_bitacora/NPC2/Intermediate_files/NPC2_genomic_genes.gff3 > Bitacora_raw.gff3
...
blastp -subject Bitacora_raws.pep.fasta -query /home/projects/ku_00039/people/joeviz/OR_annotation/OR_db/NPC2_db.fasta -out Bitacora_raws.pep.fasta.iblast.txt -outfmt "6 std qlen slen" -evalue 1e-5
...
perl /home/projects/ku_00039/people/joeviz/OR_annotation/get_blastp_parsed_newv2_nmlencut.pl Bitacora_raws.pep.fasta.iblast.txt Bitacora_raws.pep.fasta.iblast 50 1e-15
...
/services/tools/interproscan/5.47-82.0/interproscan.sh -i $f -t p -goterms -iprlookup -cpu 4     ## COMMENTED BECAUSE IT IS ALREADY RUN!!!!!


######## Run blast with NPC2 to obtain names

blastp -query Bitacora.pep.fasta -db /home/projects/ku_00039/people/joeviz/OR_annotation/Chemo_db/NPC2_db.fasta -outfmt "6 std qlen slen" -out Bitacora.pep.fasta.NPC2blast.txt -num_threads 4


######## Run script to rename the gff3 and generate the protein file and summary table

perl /home/projects/ku_00039/people/joeviz/OR_annotation/run_classification_bitacora_NPC2.pl Bitacora.gff3 $OUTDIR $GENOME
