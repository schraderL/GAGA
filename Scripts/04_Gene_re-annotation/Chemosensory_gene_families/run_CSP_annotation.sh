...
blastp -query Bitacora.pep.fasta -db /home/projects/ku_00039/people/joeviz/OR_annotation/Chemo_db/CSP_db.fasta -outfmt "6 std qlen slen" -out Bitacora.pep.fasta.CSPblast.txt -num_threads 4


######## Run script to rename the gff3 and generate the protein file and summary table

perl /home/projects/ku_00039/people/joeviz/OR_annotation/run_classification_bitacora_CSP.pl Bitacora.gff3 $OUTDIR $GENOME
