...
ALN=/home/projects/ku_00039/people/joeviz/orthology_alignments/orthogroups_with_outgroups/single_copy_100pc_aln_trees/concatenated_tree/concatenated_matrix_singlecopy_prot_trimalgap.fasta

iqtree2 -s $ALN --prefix output_singlecopy_100pc_protein_nopartition_b1000_mjttfix -B 1000 -alrt 1000 -m JTT+F+R10 -T 40 --safe --mem 170G
