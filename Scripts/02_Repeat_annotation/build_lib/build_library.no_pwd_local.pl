...
#open OUT, ">classifer.sh" | die "failed:$!\n";
`/share/app/cdhit/4.8.1/cd-hit -i $lib.100bp -o $lib.100bp.unredundance`;
`/hwfssz4/BC_COM_FP/bc_paea/Annotation_2018/software/repeat/RepeatModeler-2.0.1/RepeatClassifier -consensi $lib.100bp.unredundance`;
...
#`perl $qsub_sge $QP_para --lines 2 --cpu 100 classifer.sh`;
...
`perl $Bin/blast_database.pl $QP_para --run multi --program blastx --swissprot  --cpu $Cpu $lib.100bp.unredundance.classified.unknown`;
