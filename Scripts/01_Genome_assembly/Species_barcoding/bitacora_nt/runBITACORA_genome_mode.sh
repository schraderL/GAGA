...
export PATH=/users-d1/jvizueta/programs/ncbi-blast-2.10.0+/bin/:$PATH
export PATH=/soft/hmmer-3.1b1/binaries/:$PATH

# PATH to BITACORA Scripts folder. 
SCRIPTDIR=/users-d1/jvizueta/Chemosensory/PAIP/BITACORAv1.2.1/github/Scripts

# (Optional) In case of using GeMoMa, specify the PATH to jar file
GEMOMAP=/users-d1/jvizueta/programs/GeMoMa-1.6.4/GeMoMa-1.6.4.jar
