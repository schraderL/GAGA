...
foreach my $chem (@chemosensory){
	...
	system ("perl $dirname/gff2fasta_v3.pl $genome $chem\/$chem\_genomic_proteins_trimmed_idseqsclustered.gff3 $chem\/$chem\_genomic_proteins_trimmed_idseqsclustered");
