...
stat_TE2.pl  --  stat the TE content by type, subtype, and family
...
(5)Added superfamily: delete - and (), excepted some protected type(DNA/En-Spm,LINE/Dong-R4,LINE/Rex-Babar,Unknown/Y-chromosome)
...
=head1 Version
  ...
  Version: 2016a, Data: 2016-2-19
  Note:
  Modified: fangqi@genomics.cn, line 69 defined(@array) had been discarded after perl v5.22.1
  Data: 20180914
...
die `pod2text $0` if (! @RepeatMasker && ! @RepeatProteinMask && ! @Gff); ##defined(@array) had been discarded after perl v5.22.1 
