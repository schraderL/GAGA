...
cp /home/projects/ku_00039/people/igngod/Gene-annotation-pipeline-main/Data/Genomes/$OUTDIR/gene_families_pipeline/DEG_ENaCs/Step2_bitacora/DEG_ENaCs/DEG_ENaCs_genomic_and_annotated_proteins_trimmed_idseqsclustered.gff3 Bitacora.gff3
# Using untrimmed proteins
#cat /home/projects/ku_00039/people/igngod/Gene-annotation-pipeline-main/Data/Genomes/$OUTDIR/gene_families_pipeline/DEG_ENaCs/Step2_bitacora/DEG_ENaCs/Intermediate_files/DEG_ENaCs_annot_genes.gff3 /home/projects/ku_00039/people/igngod/Gene-annotation-pipeline-main/Data/Genomes/$OUTDIR/gene_families_pipeline/DEG_ENaCs/Step2_bitacora/DEG_ENaCs/Intermediate_files/DEG_ENaCs_genomic_genes.gff3 > Bitacora.gff3
...
######## Run blast with PPKs to obtain names
module load ncbi-blast/2.11.0+

blastp -query Bitacora.pep.fasta -db /home/projects/ku_00039/people/joeviz/OR_annotation/OR_db/Ppk_db.fasta -outfmt "6 std qlen slen" -out Bitacora.pep.fasta.PPKblast.txt -num_threads 4


######## Run script to rename the gff3 and generate the protein file and summary table

perl /home/projects/ku_00039/people/joeviz/OR_annotation/run_classification_bitacora_PPK.pl Bitacora.gff3 $OUTDIR $GENOME
